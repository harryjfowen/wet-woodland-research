// Inference data extraction for wet woodland detection
// Combines Google embeddings + LiDAR features for peat areas only

// Load peat mask for inference
var maskRaster = ee.Image('users/harryjfowen/tow_peat_mask_dissolved')
  .rename('mask')
  .unmask(255)
  .eq(255)
  .not()
...
Export.image.toDrive({
  ...
  description: 'wet_woodland_inference',
  folder: 'wetwoodland_inference',
  region: studyArea,
  scale: 5,
  maxPixels: 1e13,
  crs: 'EPSG:27700',
