...
### Extent mapping
[XGBoost](https://xgboost.readthedocs.io/) trained on [Google Earth aerial embeddings](https://earthengine.google.com/) and [Environment Agency LiDAR](https://www.data.gov.uk/dataset/f0db0249-f17b-4036-9e65-309148c97ce4/national-lidar-programme)-derived terrain metrics. Training labels drawn from three sources for comprehensive coverage: [Forestry England subcompartments](https://www.data.gov.uk/dataset/b8cb3475-f5d1-4907-b82a-13477fd6cf69/forestry-england-subcompartments2025), the [National Forest Inventory](https://www.forestresearch.gov.uk/tools-and-resources/national-forest-inventory/) (NFI) parcel dataset, and the [Trees Outside Woodland](https://www.forestresearch.gov.uk/tools-and-resources/national-forest-inventory/trees-outside-woodland/) (TOW) map. Outputs should be interpreted as indicative of wet woodland-associated tree cover rather than confirmed extent, as label coverage constrains model sensitivity.
